...
def cook_islands() :
    ...
    cook_islands["atiu"] = {"crs": crs_zone4S,
                        "lats": [-19.95, -19.95, -20.06, -20.06],
                        "lons": [-158.15, -158.06, -158.06, -158.15]}

    cook_islands["takutea"] = {"crs": crs_zone4S,
                        "lats": [-19.79, -19.79, -19.85, -19.85],
                        "lons": [-158.32, -158.26, -158.26, -158.32]}
